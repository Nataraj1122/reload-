  ...
  return (
    <div className="min-h-screen pb-24 bg-zinc-50 flex items-center justify-center p-6">
      <div className="w-full max-w-md bg-white p-12 border border-zinc-200 shadow-sm text-center">
        <h1 className="text-3xl font-serif mb-2 uppercase tracking-widest">Admin Panel</h1>
        ...
        {error && <p className="text-red-500 text-xs font-bold uppercase tracking-widest mt-6">{error}</p>}
      </div>
    </div>
  );
}
